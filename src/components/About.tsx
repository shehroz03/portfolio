...
import profilePic from 'figma:asset/4df4046b9bf7a8d2d346989ba7c8b843154a0e13.png';
      ...
      <div className="container mx-auto relative" ref={ref}>
        <div className="max-w-6xl mx-auto space-y-20">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-12 items-center">
            ...
            <div
              className={`flex-shrink-0 transition-all duration-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                }`}
            >
            ...
            <div
              className={`flex-1 space-y-6 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
                }`}
            >
          ...
          <div className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className={`relative p-8 bg-gradient-to-br from-[#0A0F1E] via-[#0B1120] to-[#050816] border border-[#1F2937] hover:border-[#6366F1] transition-all duration-300 ease-out hover:scale-[1.03] group overflow-hidden ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                      }`}
            ...
            <div
              className={`pt-8 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
            >
